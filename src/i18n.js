    ...
    resources: {
      ru: {
        translation: {
          ...
          about_items: {
            xp_year: "лет опыта",
            years: "лет",
            personal_xp: "личной экспертизы",
            trusted: "компаний доверяют нам",
          },
          about_p_1:
      ...
      en: {
        translation: {
          ...
          about_items: {
            xp_year: "years of experience",
            years: "years",
            personal_xp: "of personal expertise",
            trusted: "companies trust us",
          },
      ...
      kg: {
        translation: {
          ...
          navigation: [
            { name: "Башкы бет", link: "/#main" },
            { name: "Компания тууралуу", link: "/#about" },
            { name: "Кызматтар", link: "/#service" },
            { name: "Команда", link: "/#team" },
            { name: "Пикирлер", link: "/#feedback" },
            { name: "Байланыштар", link: "/#contact" },
          ],
          hero: "Бизнесиңиздин өсүп-өнүгүүсүнүн ар бир этабында — ишенимдүү өнөктөшүңүз",
          hero_p:
            "Жаңы шарттарда бизнесиңизди туруктуу өнүктүрүү үчүн толук жана сапаттуу кызматтарды алыңыз",
          hero_button_text: "Акысыз кеңеш",
          about: "Компания жөнүндө",
          about_items: {
            xp_year: "ашык тажрыйбабыз бар",
            years: "жылдан",
            personal_xp: "Жеке адистиги",
            trusted: "компания бизге ишенип кызмат алат",
          },
          about_p_1:
            "KAB group — бул бухгалтерлердин, аудиторлордун жана салыктар боюнча адистердин командасы.",
          about_p_2:
            "Биз Бишкек шаарында (Кыргыз Республика) ар кандай тармактагы компанияларга бухгалтердик жана кеңеш берүү кызматтарын көрсөтөбүз.",
          about_p_3:
            "Биздин милдет — каржы маселелерин тартипке келтирип, бизнеске ишенимдүү өнүгүүгө жардам берүү.",
          about_p_4:
            "Компанияларды ар бир баскычта коштойбуз: бухгалтердик эсеп, салык, аудит жана консалтинг. Отчётторду даярдайбыз, текшерүүлөргө катышабыз, мамлекеттик органдар менен байланышып беребиз. Ишкерлердин убактысын үнөмдөп, ашыкча түйшүктөн сактайбыз.",
          account: {
            title: "Кошумча түйшүксүз бухгалтерия",
            cards: [
              {
                title: "Жеке бухгалтер",
                description:
                  "Бизнесиңизди жакшы билген жана дайыма байланышка чыга турган адис менен камсыздайбыз.",
              },
              {
                title: "Купуялуулук жана коргоо",
                description:
                  "Маалыматтарыңыз ишенимдүү корголгон жана коопсуз колдордо.",
              },
              {
                title: "Компанияны Анна Калинина жетектейт",
                description:
                  "25 жылдык тажрыйбасы бар 1-даражадагы сертификатталган аудитор жана салык боюнча консультант. Анын кесипкөйлүгү жана майда-баратка кылдат мамилеси Кыргызстан боюнча кардарлардын ишениминин негизин түздү.",
              },
              {
                title: "Тажрыйбалуу команда",
                description:
                  "Орточо тажрыйба — 10 жылдан ашык. Мыйзамдагы бардык өзгөрүүлөрдү өз убагында эске алабыз.",
              },
              {
                title: "Айыпсыз отчёттуулук",
                description:
                  "Бардык отчётторду өз убагында, так жана тобокелдиксиз тапшырабыз.",
              },
            ],
          },
          service: {
            title: "Бардык түрдөгү бизнес үчүн кызматтар",
            description:
              "Бизнесиңизди жөнгө салып, процесстердин сапатын ашыкча чыгымдарсыз жакшыртууга көмөктөшөбүз",
            card: [
              {
                title: "Бухгалтердик кызматтар",
                description_items: [
                  "Бухгалтердик жана салыктык эсепти жүргүзүү",
                  "Мурунку мезгилдердин эсебин калыбына келтирүү",
                  "Каржылык отчёттуулукту түзүү",
                  "Базага экспресс-талдоо жүргүзүү",
                ],
                bg_colors: "#EAF2FF",
              },
              {
                title: "Салыкты коштоп жүрүү",
                description_items: [
                  "Салыктык отчёттуулукту түзүү жана тапшыруу",
                  "Салыктарды оптималдаштыруу жана режимди тандоо",
                  "Текшерүү жыйынтыктарына байланыштуу маселелерди чечүүгө жардам беребиз",
                  "Салыктар боюнча түшүндүрмө жана кеңештерди беребиз",
                ],
                bg_colors: "#FFF3E9",
              },
              {
                title: "Аудит жана тышкы долбоорлор",
                description_items: [
                  "Салыктык абалды баалоо жана алдын ала аудит",
                  "Салык текшерүүлөрүнө даярдоого жардам берүү",
                  "Салыктык текшерүүлөрдө коштоп жүрүү",
                  "Мамлекеттик органдарда компанияны өкүлчүлүк кылуу",
                  "Финансылык жана салыктык эсеп үчүн эсеп саясатын түзүү",
                ],
                bg_colors: "#F3EDFF",
              },
              {
                title: "Кадрлар эсеби",
                description_items: [
                  "Буйруктар жана табелдер",
                  "Эмгек келишимдери жана ЖЧК/ГПХ келишимдери",
                  "Кошумча макулдашуулар",
                  "Кадрдык иш-кагаздарын толук жүргүзүү",
                ],
                bg_colors: "#F4F6FB",
              },
              {
                title:
                  "Бажы мыйзамдары жана тышкы экономикалык ишмердүүлүк (ВЭД/ТИЖ) боюнча консультациялар",
                description_items: [
                  "Товарларды импорттоо жана экспорттоо, документтерди даярдоо, бажы режимин тандоо жана тышкы экономикалык келишимдерди коштоп жүрүү боюнча эксперттик жардам көрсөтөбүз.",
                  "Импорт жана экспорт эрежелерин, бажы режимдерин, тарифтерди жана төлөмдөрдү түшүндүрүп беребиз",
                  "Бажы жол-жоболоштуруусу үчүн керектүү документтердин толук топтомун даярдап беребиз",
                  "Тышкы экономикалык операцияларды Кыргыз Республикасынын мыйзамдарына жана эл аралык нормаларга ылайык оптималдаштырабыз",
                  "Келишимдер, төлөмдөр, логистика жана жүк ташуу маселелери боюнча адистештирилген кеңештерди сунуштайбыз",
                ],
                bg_colors: "#E9F7EE",
              },
            ],
            ...
            cards: [
              {
                name: "Анна Калинина",
                description:
                  "Компаниянын жетекчиси. 25 жылдан ашык тажрыйбасы бар. Сертификацияланган аудитор, 1-даражадагы салык боюнча кеңешчи, бажы брокери. Бухгалтердик эсеп, салыктык эсеп жана тышкы соода боюнча жогорку деңгээлдеги эксперт.",
              },
              {
                name: "Рубанова Ирина",
                description:
                  "Алдыңкы бухгалтер, методист. 17 жылдан ашык тажрыйбасы бар. Эсеп жүргүзүү процесстерин уюштурууда жана методологиялык колдоодо адис.",
              },
              {
                name: "Мирная Виктория",
                description:
                  "Алдыңкы бухгалтер, аналитик. 12 жылдан ашык тажрыйбасы бар. Каржылык анализ жана башкаруучулук эсеп боюнча эксперт.",
              },
              {
                name: "Нестерова Агата",
                description:
                  "Алдыңкы бухгалтер. 10 жылдан ашык тажрыйбасы бар. Бардык бухгалтердик процесстерди так жана сапаттуу көзөмөлдөйт.",
              },
              {
                name: "Аюпова Ризвангуль",
                description:
                  "Алдыңкы бухгалтер. 19 жылдан ашык тажрыйбасы бар. Коммерциялык эмес уюмдардын эсеби жана Эл аралык каржылык отчёттуулуктун стандарттары боюнча адис.",
              },
              {
                name: "Кебекова Айканыш",
                description:
                  "Алдыңкы бухгалтер. 5 жылдан ашык тажрыйбасы бар. 1С программасында иштөөнү мыкты билет жана эсептин тактыгын камсыздайт.",
              },
              {
                name: "Жылдызбекова Малика",
                description:
                  "Алдыңкы бухгалтер. 5 жылдан ашык тажрыйбасы бар. Бухгалтердик эсепти жана отчёттуулукту так жана профессионалдуу жүргүзөт.",
              },
              {
                name: "Темирбаева Эльнура",
                description:
                  "Бухгалтер. 5 жылдан ашык тажрыйбасы бар. Майда-баратка кылдат мамилеси менен эсептик процесстерди так жана натыйжалуу жүргүзөт.",
              },
              {
                name: "Кубанычбекова Айдай",
                description:
                  "Алдыңкы бухгалтер. 9 жылдан ашык тажрыйба. Эсепти так жүргүзүп, отчётторду өз убагында жана сапаттуу тапшырат.",
              },
            ],
          },
          feedback: {
            ...
            cards: [
              {
                name: "Сарбагишев Кылычбек Карыпбекович",
                title:
                  "Кыргыз Республикасынын Улуттук Олимпиада комитетинин Башкы катчысы",
                feedback:
                  "Кыргыз Республикасынын Улуттук Олимпиада комитети ИП Калинина А.В. бухгалтердик компаниясына милдеттерин жогорку кесипкөйлүк жана жоопкерчилик менен аткарганы үчүн ыраазычылык билдирет. Иш жогорку сапатта, өз убагында жана мыйзам талаптарына толук ылайык аткарылат. Адистердин жогорку деңгээлдеги компетенттүүлүгүн жана пайда болгон суроолорду ыкчам чечүү жөндөмүн өзгөчө белгилейбиз. Компанияны бухгалтердик жана салыктык коштоо жаатында ишенимдүү өнөктөш катары сунуштайбыз.",
              },
              {
                name: "Перфильев Всеволод Юрьевич",
                title:
                  "Жоопкерчилиги чектелген коом «ДваГИС-Бишкек» компаниясынын башкы директору",
                feedback:
                  "Компаниябызга 3 жылдан ашык ийгиликтүү кызмат көрсөтүп келгени үчүн ыраазычылык билдиребиз. Бул убакыт ичинде биздин иш жогорку сапатта коштолуп, бардык суроолор өз убагында чечилип, керектүү кенештер берилип турду. Куратор ар дайым байланышта болду. Кызматташуу мезгилинде өз ара байланыш ыңгайлуу жана түшүнүктүү болуп, көрсөтүлгөн кызматтар жогорку кесипкөйлүк менен аткарылып турду. Компаниянын мындан аркы өсүшүнө жана ийгиликтерине тилектешмин. Бухгалтердик коштоо боюнча бул компанияны ишенимдүү өнөктөш катары сунуштайм.",
              },
              {
                name: "Лим Владимир Алексеевич",
                title:
                  "Жоопкерчилиги чектелген коом “Азия Моторс” компаниясынын директору",
                feedback:
                  "Бул компания менен бир нече жылдан бери кызматташып келебиз жана алардын туруктуу, ишенимдүү кызматташуусу, жогорку кесипкөлүгү жана кардарга кылдат мамилеси үчүн терең ыраазычылык билдиребиз. Кызматташуунун бүтүндөй мезгилинде компания өз компетенттүүлүгүн жана жоопкерчилигин ар дайым көрсөтүп, бардык суроолорду тез жана сапаттуу чечип турду. Команда менен байланыш дайыма жагымдуу, түшүнүктүү жана конструктивдүү жүрөт. Биз кызматташуубузду жогору баалайбыз жана алдыда дагы көп жылдык ийгиликтүү биргелешкен иш болоруна ишенебиз.",
              },
              {
                name: "Айгюн Халил Ибрахим",
                title:
                  "Жоопкерчилиги чектелген коом «Кыргыз Бетон» компаниясынын директору",
                feedback:
                  "ЖЧК «Кыргыз Бетон» компаниясы узак мөөнөттүү кызматташуу, жогорку сапаттагы кызматтар жана компания кызматкерлеринин кылдат мамилеси үчүн ыраазычылык билдирет. Биз мындан ары да өз ара пайдалуу жана ийгиликтүү кызматташуубуз уланат деп ишенебиз. Ошондой эле биргелешкен ишибиздин көрсөткүчтөрү мындан ары да өсө берет деген ишеним бар.",
              },
              {
                name: "Турарбек Улан",
                title:
                  "Жоопкерчилиги чектелген коом «Shagyl Tash» компаниясынын директору",
                feedback:
                  "ЖЧК «Shagyl Tash» компаниясы узак убакыттан бери жүрүп келе жаткан жемиштүү кызматташуу жана жоопкерчиликтүү өнөктөштүк мамиле үчүн чын жүрөктөн ыраазычылык билдирет. Сиздерге финансылык туруктуулук, ийгилик жана өз ара мамилебиздин мындан ары да бекемделишин каалайбыз!",
              },
              {
                name: "Мырзамамытова Аида Мырзамитовна",
                title:
                  "Жоопкерчилиги чектелген коом «Эс Ал Мебель» компаниясынын жетекчиси",
                feedback:
                  "КАВ group by Anna Kalinina командасынын кесипкөйлүгү жана компетенттүүлүгү биз үчүн абдан маанилүү. 2017-жылдан бери кызматташып келебиз жана бул убакыттын ичинде кызматташуу жогорку деңгээлде жүргүзүлүп келди. Кызматташуубуз мындан ары да жемиштүү уланат деп ишенебиз. КАВ group by Anna Kalinina компаниясын жогорку деңгээлдеги аудитордук кызматтарды көрсөтө алган ишенимдүү өнөктөш катары ишенимдүү сунуштайбыз. Сиздерге өсүп-өнүгүү жана ийгилик каалайбыз!",
              },
              {
                name: "Арслан Айкан",
                title:
                  "Жоопкерчилиги чектелген коом «Шагыл Таш-Токмок» компаниясынын директору",
                feedback:
                  'ЖЧК "Шагыл Таш-Токмок" ИП Калинина А.В. бухгалтердик компаниясына кызматташканы үчүн чоң ыраазычылык билдирет жана аны ишенимдүү, жоопкерчиликтүү бизнес шерик катары сунуштайт. Сиздерге өсүп-өнүгүү жана ийгилик каалайбыз, кызматташууну улантууга кубанычта болобуз!',
              },
            ],
          },
          form: {
            title: "Эсепти тартипке келтирүүчү 3 кадам",
            description_items: [
              "Учурдагы эсеп маселелерди жана көйгөйлөрдү бирге талкуулайбыз",
              "Бизнесиңиз үчүн эң ылайыктуу чечимди сунуштайбыз",
              "Ишти баштайбыз —отчёттуулук так жана өз убагында жүргүзүлүп турат.",
            ],
            form_text: {
              name_input: "Аты-жөнү*",
              email_input: "E-mail*",
              phone_input: "Телефон*",
              button_text: "Өтүнмө калтыруу",
              warning_text:
                "“Өтүнмө калтыруу” баскычын басуу менен мен жеке маалыматтарым Кыргыз Республикасынын мыйзамдарына ылайык иштетилишине макулдугумду берем.",
            },
          },
          footer: {
            description:
              "2006-жылдан бери биз бизнес үчүн бухгалтердик эсепти жогорку деңгээлде жүргүзүүгө жардам берип келебиз.",
            terms: "Жеке маалыматтарды коргоо жөнүндө макулдашуу",
            info_title: "Дарек",
            adress: "Бишкек ш., Малдыбаева көч, 54Б, 6-кеңсе",
            work_time: "Дүйшөмбү–Жума, 08:00–17:00 (түшкү тыныгуу 12:00–13:00)",
            map_button_text: "Картадан көрсөтүү",
            nav_text: "Навигация ",
            about_text: "Компания тууралуу",
            service_text: "Кызматтар",
            team_text: "Команда",
            feedback_text: "Пикирлер",
            contact_text: "Байланыштар",
            copyright_text:
              "2025 © KAB group by Anna Kalinina. Бардык укуктар корголгон.",
            author_text: "Сайттын иштелиши жана дизайны:",
          },
          terms: {
            title: "Коргоо келишими өздүк маалымат",
            intro:
              "Мен өз эрким жана аң сезимим менен 2009 жылдын 14 апрелиндеги номур 58 инчи “ Жеке маалымат жөнүндөгү” КР мыйзамына ылайык  Жеке ишкер Калинина Анна Владимировна ( мындан ары ОПЕРАТОР деп аталуучу) жеке маалыматтарымды иштетүүгө төмөнкүгө макулдугумду берем:",
            intro_items: [
              "жеке маалыматтарды иштетүү үчүн ( жеке маалыматтын кармоочусу (ээси) тарабынан же анын тапшырмасы боюнча, автоматтык түрдө же ансыз маалыматтарды чогултуу, жазуу сактоо, актуалдаштыруу, топко чогултуу, блокко салуу, өчүрүү жанажокко чыгаруу максатында ар кандай ыкмаларга карабастан аткарылуучу ар кандай операция же операциялардын комплекси. Ошондой эле:",
              "“Жеке маалыматтар жөнүндө” КР мыйзамына жана эл аралык келишимдерге ылайык,  жеке маалыматты кармоочу ( ээси) тарабынан маалыматты 3 жакка берүү.",
              "Жеке маалыматтарды трансчекаралык өткөрүп берүү ( жеке маалыматтарды кармоочу ( ээси ) тарабынан башка мамлекеттердин юрисдикциялыгындагы кармоочуларга төмөнкү жеке маалыматтарды өткөрүп берүү:",
            ],
            intro_body:
              "Мен тараптан берилген жана төмөнкүлөрдү камтыган баардык категориядагы жеке маалыматтарды иштетүүгө макулдук берилет:",
            body_items: [
              "Фамилиясы аты атасынын аты",
              "Жеке идентификациялык номуру",
              "Туулган күнү, айы, жылы",
              "Жынысы",
              "Жеке идентификациялык маалыматы",
              "Паспорт жөнүндө маалымат (сериясы, номери, берилген күнү, кайсы орган тарабынан берилгендиги, жарандын жашаган дареги (каттоодон өткөн жана чыныгы))",
              "Уюмдун аталышы",
              "Уюмдун ИНН жана ОКПОсу",
              "Үй жана чөнтөк телефонунун номерлери",
              "Электрондук дарек",
              "Паспорттун номери жана жарактуулук мөөнөтү",
              "Башка маалыматтар",
            ],
            body_1:
              "1.   Оператор төмөнкү иш аракеттерге укуктуу: маалыматтарды чогултууга, жазууга, жоопту системалаштырууга, маалыматтарды топтоого, сактоого, тактоого, жаңыртууга, өзгөртүүгө, чыгарып алууга, колдонууга, бөгөт салууга, жок кылууга жана өчүрүгө.",
            body_2:
              "2.   Автоматташтыруу куралдарын колдонуу менен же автоматташтыруу куралдарын колдонбостон жеке маалыматтарды иштетүү ыкмалары.",
            body_3:
              "3.   Иштетүүнүн максаты: кызмат көрсөтүүлөрдү, иштерди, анын ичинде жолдомолорду, кызмат көрсөтүүлөргө же көрсөтүлгөн иштерге байланыштуу билдирүүлөрдү берүү, суроо-талаптарга жоопторду даярдоо жана жөнөтүү, окуялар же товарлар же кызматтар жана оператордун иши жөнүндө маалымат",
            conclution: "Мен төмөнкү маалымат менен таанышып чыктым:",
            conclution_items: [
              " Жеке маалыматтарды иштеп чыгууга макулдук ушул макулдукка кол коюлган күндөн тартып мага мамлекеттик муниципалдык кызматтарды көрсөтүүнүн жана Кыргыз Республикасынын мыйзамдарына ылайык кызматтарды көрсөтүү жөнүндө маалыматтарды сактоонун бүткүл мезгилине жарактуу болуп саналат.",
              " Жеке маалыматтарды иштетүүчүгө макулдук audit.buhuchet@mail.ru электрондук почта дарегине  ( сөзсүз түрдө чыныгы жашаган дарегине) жөнөтүлгөн каалаган формада жазуу жүзүндөгү арыздын негизинде кайра чакырылып алышы мүңкүн.",
              'Жеке маалыматтарды иштеп чыгууга макулдук кайтарылып алынган учурда, менин жеке маалыматтарымды толугу менен же жарым-жартылай иштетүү "Жеке маалыматтар жөнүндө" Кыргыз Республикасынын 2009-жылдын 14-апрелиндеги № 58 Мыйзамынын 5 жана 15-статьяларына ылайык улантылышы мүмкүн.',
            ],
          },
          overlay: {
            p: "2006-жылдан бери биз бизнес үчүн бухгалтердик эсепти жогорку деңгээлде жүргүзүүгө жардам берип келебиз.",
            title: "Бухгалтерияны бизге тапшырыңыз",
            title_p:
              "Отчёттуулукту жабабыз, эсепти иреттейбиз, үнөмдөөгө жардам беребиз.",
            input_1: "Аты-жөнү*",
            input_2: "E-mail*",
            input_3: "Телефон*",
            input_submit: "Өтүнмө калтыруу",
            terms_text:
              "“Өтүнмө калтыруу” баскычын басуу менен мен жеке маалыматтарым Кыргыз Республикасынын мыйзамдарына ылайык иштетилишине макулдугумду берем.",
            success_text: "Рахмат!",
            success_text_p:
              "Сиздин кайрылуу кабыл алынды.Өтүнмөдө көрсөткөн номериңизге жакында байланышабыз — чалууну өткөрүп жибербеңиз.",
            contact: "Эгер маселе шашылыш болсо, бизге чалыңыз:",
            wa_button_text: "WhatsAppка өтүү",
            tel_button_text: "Telegramга өтүү",
          },
        },
      },
    },
